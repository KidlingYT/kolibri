<template>
  ...
  <ImmersivePage
    :appBarTitle="$tr('editBackupScheduleTitle')"
    :route="goBackRoute"
    :icon="icon"
  >
    <KPageContainer
    ...
    >
      ...
      >
        <KGridItem>
          <h1>{{ $tr('editBackupScheduleTitle') }}</h1>
        </KGridItem>
  ...
  export default {
    ...
    $trs: {
      editBackupScheduleTitle: {
        message: 'Edit device backup schedule',
        context: 'Subtitle for the edit backup schedule page',
      },
      serverTime: {
        message: 'Server time:',
      ...
      removeDeviceWarning: {
        message: 'You are about to remove this device from the backup schedule.',
      ...
      removeDeviceLabel: {
        message: 'Remove the backup schedule',
        context: 'Button label for removing the backup schedule',
      },
      frequency: {
        message: 'Frequency',
        context: 'Indicates often the scheduled backup occurs',
      },
      day: {
        message: 'Day',
